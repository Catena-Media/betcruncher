...
module.exports = (function () {
    ...
    var winAmount, amounts, eachWayAmounts, totalStake, betTypes, calculator, nullResult;
     ...
     */
    calculator = function calculator(betslip, runners) {
        ...
        if (!betTypes.hasOwnProperty(betslip.type)) {
